...
function drawActs(chart) {
  ...
  const everything: {part1: ImportantEvent[], part2: ImportantEvent[]} = {
    ...
    part2: [
      ...
      {title: 'Act 6 Act 3', page: 4820, subtitle: 'Nobles', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 4', page: 5438, subtitle: 'Void', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 6', page: 6243, subtitle: '', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 6 Act 2', page: 6475, subtitle: '', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 6 Act 3', page: 6853, subtitle: '', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 6 Act 4', page: 6921, subtitle: '', color: 'green'},
      {
      ...
      {title: 'Act 6 Act 6 Act 5', page: 7409, subtitle: '', color: 'green'},
      {
